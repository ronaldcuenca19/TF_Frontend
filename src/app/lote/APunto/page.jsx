...
import { all_lote_producto, all_product_caducado, all_product_fresco, all_product_por_caducar, cambiarEstado } from "@/src/hooks/service_producto";
...
export default function Page() {
    ...
    useEffect(() => {
        if (!obt) {
            all_product_por_caducar().then((info) => {
                console.log(info);
                if (info.code === 200) {
                    setLote(info.datos);
                    setObt(true);
